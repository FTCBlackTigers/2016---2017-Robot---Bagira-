...
@Autonomous(name = "BlackTigersAutoBlueShoot&Parking&BallFar", group = "BlackTigers Auto")
    public class BlackTigersAutoBlueShootAndParkingAndBallFar extends LinearVisionOpMode {
