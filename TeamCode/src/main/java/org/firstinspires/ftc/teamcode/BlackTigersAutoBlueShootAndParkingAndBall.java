...
@Autonomous(name = "BlackTigersAutoBlueShoot&Parking%Ball", group = "BlackTigers Auto")
    public class BlackTigersAutoBlueShootAndParkingAndBall extends LinearVisionOpMode {
