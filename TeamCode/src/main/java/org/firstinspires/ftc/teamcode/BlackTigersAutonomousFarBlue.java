...
@Autonomous(name = "Black Tigers Vision Blue Auto Far", group = "BlackTigers Auto")
public class BlackTigersAutonomousFarBlue extends LinearVisionOpMode {
